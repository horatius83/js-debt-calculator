...
<div class="container">
    ...
    <div id="payment-planning" v-if="!paymentPlan">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <label for="strategy-select" class="form-label">Payment Strategy</label>
                <select class="form-select" aria-label="Strategy Selection" id="strategy-select" v-model="strategy">
